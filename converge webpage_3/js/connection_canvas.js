...
Particle = function () {
  function Particle(canvas, options) {_classCallCheck(this, Particle);
  ...
  }_createClass(Particle, [{ key: 'getCoordinates', value: function getCoordinates()
    ...
    } }, { key: 'randomIntFromInterval', value: function randomIntFromInterval(
    ...
    } }, { key: 'createArcFill', value: function createArcFill(
    ...
    } }, { key: 'createArcEmpty', value: function createArcEmpty(
